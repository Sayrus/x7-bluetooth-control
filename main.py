...
hw_button_parser = sub_parsers.add_parser("set_hardware_button", help="Set a hardware button")
hw_button_parser.add_argument("button", type=X7HardwareButtons.argparse, choices=list(X7HardwareButtons))
hw_button_parser.add_argument("state", type=int, help="???")
